...
function Page() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Page.useEffect": ()=>{
            ...
            function getSnack() {
                return new Promise({
                    "Page.useEffect.getSnack": (resolve)=>{
                        setTimeout({
                            "Page.useEffect.getSnack": ()=>{
                                console.log('小丸子说："我找到章鱼烧了！"');
                                resolve();
                            }
                        }["Page.useEffect.getSnack"], 1000);
                    }
                }["Page.useEffect.getSnack"]);
            }
            getSnack().then({
            ...
            async function getHomework() {
                await new Promise({
                    "Page.useEffect.getHomework": (resolve)=>{
                        ...
                        }["Page.useEffect.getHomework"], 1000);
                    }
                }["Page.useEffect.getHomework"]);
            }
            ({
            ...
            async function getMarukoStories() {
                ...
                try {
                    ...
                    // 提取每个提交的日期和消息
                    const stories = commits.map({
                        "Page.useEffect.getMarukoStories.stories": (commit)=>({
                                date: new Date(commit.commit.author.date).toLocaleDateString('zh-CN'),
                                message: commit.commit.message
                            })
                    }["Page.useEffect.getMarukoStories.stories"]);
                    // 生成表格HTML
                    const tableRows = stories.map({
                        "Page.useEffect.getMarukoStories.tableRows": (story)=>`
          <tr class="border-b border-pink-100">
            <td class="py-2 px-4">${story.date}</td>
            <td class="py-2 px-4">${story.message}</td>
          </tr>
        `
                    }["Page.useEffect.getMarukoStories.tableRows"]).join('');
                    const html = `
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "今天小丸子要教大家异步编程！就像小丸子一边写作业一边想着要吃章鱼烧一样，我们也可以让程序做多件事情哦~ (◕‿◕✿)"
                            }, void 0, false, {
                                fileName: "[project]/src/app/practice/07-async-01/page.tsx",
                                lineNumber: 148,
                                columnNumber: 11
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: "就像小丸子答应妈妈要写完作业才能去玩，这就是一个承诺呢！"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/practice/07-async-01/page.tsx",
                                                lineNumber: 167,
                                                columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "text-gray-600",
                                                children: "就像小丸子等待章鱼烧烤好一样，要有耐心等待结果哦！"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/practice/07-async-01/page.tsx",
                                                lineNumber: 173,
                                                columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "text-gray-600",
                                                children: "就像小丸子去便利店买零食，要先和店员说想要什么呢！"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/practice/07-async-01/page.tsx",
                                                lineNumber: 179,
                                                columnNumber: 15
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                dangerouslySetInnerHTML: {
                                    __html: tableHtml || '<p class="text-center text-gray-500">小丸子正在收集故事中...</p>'
                                }
                            }, void 0, false, {
                                fileName: "[project]/src/app/practice/07-async-01/page.tsx",
                                lineNumber: 197,
...
//# sourceMappingURL=src_app_practice_07-async-01_page_tsx_97907a57._.js.map